...
@section('title', trans('general.new').' '.trans('general.agent'))
            ...
            <div class="card-box">
                ...
                <div class="row">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 input-group">
                            {!! Form::text('office_name', null, ['class'=>'form-control','placeholder'=>trans('general.office')]) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 input-group">
                            {!! Form::select('primary_phone', \KW\Transactions\Models\PhoneType::get()->lists('name'), null, ['class'=>'form-control select2','placeholder'=>trans('general.select')]) !!}
                        </div>
                    </div>
                </div>
