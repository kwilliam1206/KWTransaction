...
@section('title', trans('general.edit').' '.trans('general.agent'))
@section('page_heading')
    <div class="row">
        <h4 class="page-title">
            {{trans('general.new')}} {{trans('general.agent')}} {{trans('general.contact')}}
        </h4>
    </div>
@endsection
@section('content')
    {!! Form::model($contact,['id'=>'contact_form','method' => 'put', 'route' => ['contact.update',$contact->id],'class' => 'form-horizontal', 'role'=>'form']) !!}
    {!! Form::hidden('type_id',$contact->type->id) !!}
    <div class="row">
        <div class="col-sm-6">
            <div class="card-box">
                ...
                <div class="row">
                    <div class="form-group row">
                        {!! Form::label('office_name', trans('general.office') ,['class' => 'col-lg-3 control-label']) !!}
                        <div class="col-lg-9 input-group">
                            {!! Form::email('office_name', null, ['class'=>'form-control','placeholder'=>trans('general.office')]) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 input-group">
                            {!! Form::email('office_phone', $contact->officePhone->number ?? null, ['class'=>'form-control','placeholder'=>trans('contact.office_phone')]) !!}
                ...
                <div class="row">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 input-group">
                            {!! Form::email('mobile_phone', $contact->mobilePhone->number ?? null, ['class'=>'form-control','placeholder'=>trans('contact.mobile_phone')]) !!}
                            <span class="input-group-addon"><i class="fa fa-phone"></i></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 input-group">
                            {!! Form::email('home_phone', $contact->homePhone->number ?? null, ['class'=>'form-control','placeholder'=>trans('contact.home_phone')]) !!}
                            <span class="input-group-addon"><i class="fa fa-phone"></i></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 input-group">
                            {!! Form::select('primary_phone', \KW\Transactions\Models\PhoneType::get()->pluck('name','id'), $contact->primaryPhone->type->id ?? null, ['class'=>'form-control select2','placeholder'=>trans('general.select')]) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 input-group">
                            {!! Form::select('state_id', $states, null, ['required','id'=>'state_select','class'=>'form-control select2']) !!}
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 input-group">
                            {!! Form::select('city_id', $cities , null, ['required','id'=>'city_select','class'=>'form-control select2']) !!}
                        </div>
                    </div>
                </div>
                <div class="row">
