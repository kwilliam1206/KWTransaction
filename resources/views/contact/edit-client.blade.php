...
@section('title', trans('general.edit').' '.trans('general.client'))
@section('page_heading')
    <div class="row">
        <h4 class="page-title">
            {{trans('general.edit')}} {{trans('general.client')}} {{trans('general.contact')}}
        </h4>
    </div>
@endsection
@section('content')
            ...
            <div class="card-box">
                ...
                <div class="row">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 input-group">
                            {!! Form::email('mobile_phone', $contact->homePhone->number ?? null, ['class'=>'form-control','placeholder'=>trans('contact.mobile_phone')]) !!}
                            <span class="input-group-addon"><i class="fa fa-phone"></i></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group row">
                        {!! Form::label('primary_phone', trans('contact.primary_phone') ,['class' => 'col-lg-2 control-label']) !!}
                        <div class="col-lg-9">
                            {!! Form::select('primary_phone', \KW\Transactions\Models\PhoneType::get()->pluck('name', 'id'), $contact->primaryPhone->type->id ?? null, ['class'=>'form-control select2','placeholder'=>trans('contact.primary_phone')]) !!}
                        </div>
                    </div>
                </div>
                <div class="row">
