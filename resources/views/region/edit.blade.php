...
@section('title', trans('region.edit_region'))
@section('page_heading')
    <div class="row">
        <h4 class="page-title">
            {{ trans('region.edit_region') }}
        </h4>
    </div>
@endsection
@section('content')
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="card-box">
                ...
                {!! Form::model($region, array('route' => ['region.update', $region->id], 'method' => 'put', 'class' => 'form-horizontal')) !!}
                ...
                <div class="row">
                    <button type="submit" class="btn btn-primary waves-effect waves-light pull-right">{{ trans('general.form_submit') }}</button>
                </div>
            ...
            <div class="panel">
                <div class="panel-body">
                    ...
                    <div id="datatable-editable_wrapper"
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <table id="datatable-editable" class="table table-striped table-bordered dt-responsive nowrap dataTable" cellspacing="0"
                                       width="100%">
                                    <thead>
                                    <tr>
                                        <th>ID</th>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($region->customFinancialAttributes as $attr)
                                        <tr>
            ...
            var EditableTable = {
                ...
                rowSave: function ($row) {
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        data: {id: values[0], type_id: values[2], value: values[3], region_id: '{{$region->id}}'}
                    }).done(function (data) {
                        if (data.success) {
                            $row.off('click', 'button.attr_type');
