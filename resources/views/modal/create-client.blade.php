...
@section('modal.content')
    ...
    <div class="row">
        <div class="form-group row">
            ...
            <div class="col-lg-9 input-group">
                {!! Form::select('primary_phone', \KW\Transactions\Models\PhoneType::get()->pluck('name', 'id'), null, ['class'=>'form-control select2','placeholder'=>trans('contact.primary_phone')]) !!}
            </div>
        </div>
    </div>
    <div class="row">
